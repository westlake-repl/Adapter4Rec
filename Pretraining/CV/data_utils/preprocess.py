...
def read_behaviors(behaviors_path, before_item_id_to_keys, before_item_name_to_id, max_seq_len, min_seq_len, Log_file):
    ...
    Log_file.info("##### items after clearing {}, {}, {}, {}#####".format(item_num, item_id - 1, len(item_id_to_keys),
                                                                          len(item_id_before_to_now)))
    users_train = {}
    users_valid = {}
    users_test = {}
    ...
    Log_file.info("##### interaction number {}#####".
                  format(count_interaction))
