...
adapter_cv_lr_list = [3e-3]
adapter_sasrec_lr_list = [3e-3]
                                ...
                                for embedding_dim in embedding_dim_list:
                                    for fine_tune_lr in fine_tune_lr_list:
                                        ...
                                        run_py = "CUDA_VISIBLE_DEVICES='0,1,2,3' \
                                                 python  -m torch.distributed.launch --nproc_per_node 4 --master_port 1245\
                                            ...
                                            , fine_tune_to, finetune_layernorm, is_serial, adapter_type)
                                        os.system(run_py)
