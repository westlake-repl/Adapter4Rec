...
adapter_cv_lr_list = [1.5e-5]
adapter_sasrec_lr_list = [1.5e-5]
                                    ...
                                    for fine_tune_lr in fine_tune_lr_list:
                                        ...
                                        run_py = "CUDA_VISIBLE_DEVICES='0,1,2,3' \
                                                ...
                                                --adapter_sasrec_lr {} --adapter_cv_lr {} --adding_adapter_to {} --fine_tune_to {}\
                                                 --finetune_layernorm {} --is_serial {} --adapter_type {} --use_scale {}\
                                                 ".format(
                                            ...
                                            , fine_tune_to, finetune_layernorm, is_serial, adapter_type, use_scale)
                                        os.system(run_py)
